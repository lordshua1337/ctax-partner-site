...
var CH_DAYS = [
  ...
  { day: 4, title: 'Build your referral intro script', desc: 'Use the Script Builder to create a natural conversation starter for bringing up IRS resolution with clients.', pts: 150, tool: 'page-scripts' },
  ...
  { day: 9, title: 'Write your first referral intro email', desc: 'Use the Script Builder to generate a warm introduction email for a client you think could benefit from IRS resolution help.', pts: 150, tool: 'page-scripts' },
  ...
  { day: 12, title: 'Create a social media ad', desc: 'Use the Ad Maker to build a co-branded social post you can share on LinkedIn or Facebook.', pts: 150, tool: 'page-admaker' },
  ...
  { day: 15, title: 'Qualify a client with the AI tool', desc: 'Use the Client Qualifier to analyze a potential client situation and see their referral strength score.', pts: 150, tool: 'page-resources' },
  ...
  { day: 18, title: 'Build an email drip sequence', desc: 'Create 3 follow-up email templates using the Script Builder. Space them out for weekly sends.', pts: 170, tool: 'page-scripts' },
  ...
  { day: 24, title: 'Generate a new ad creative', desc: 'Create a second ad in Ad Maker with a different template and message. A/B test your outreach.', pts: 150, tool: 'page-admaker' },
